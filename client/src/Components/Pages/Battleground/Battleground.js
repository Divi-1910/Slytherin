	...
	const upcomingContests = [
		{
			...
			date: "2024-08-20",
			time: "10:00 AM",
			description: "A fun coding contest.",
		},
		{
			name: "Contest B",
			date: "2024-08-25",
	...
	const pastContests = [
		{
			...
			date: "2024-07-15",
			time: "9:00 AM",
			description: "Great coding event.",
		},
		{
			name: "Contest D",
			date: "2024-07-30",
			time: "3:00 PM",
			description: "Another exciting contest.",
		},
	];
		...
		<div
			...
			<section className="upcoming-contests mb-8">
				...
				{upcomingContests.map((contest, index) => (
					<div
						key={index}
						className={`contest-card p-4 ${
							isDarkMode ? "bg-gray-800" : "bg-green-50"
						} shadow-lg rounded-lg mb-4 flex items-center justify-between`}>
